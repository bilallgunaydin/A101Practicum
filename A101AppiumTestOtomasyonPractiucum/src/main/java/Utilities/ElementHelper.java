...
public class ElementHelper {
     ...
     * @param text
     */
    public boolean checkElementWithTextTrueOrFalse(By key, String text) {
        boolean find = false;
    ...
    public void Assertion(WebElement key, String check) {

        Assert.assertEquals(key.getText(),check);
